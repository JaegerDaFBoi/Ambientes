...
<head>
  ...
  <title>AmbientesSENA/Dashboard</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo APP_URL; ?>assets/plugins/fontawesome-free/css/all.min.css">  <!-- plugins/fontawesome-free/css/all.min.css -->
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
  <!-- Tempusdominus Bbootstrap 4 -->
  <link rel="stylesheet" href="<?php echo APP_URL; ?>assets/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  <!-- iCheck -->
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="<?php echo APP_URL; ?>assets/plugins/summernote/summernote-bs4.css">
  ...
  <nav class="main-header navbar navbar-expand navbar-orange navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo APP_URL; ?>initial/index" class="nav-link">Inicio</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Ver Horarios</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Asignacion de horarios</a>
      </li>
    </ul>
  </nav>