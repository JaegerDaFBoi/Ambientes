            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <input readonly type="text" class="form-control" id="instructorHours" name="instructorHours" value="<?php echo $instructor->horassemana; ?>">
                </div>
              </div>
              <div class="row">
                <label>Correo Electronico</label>
                <input readonly type="email" class="form-control" id="instructorEmail" name="instructorEmail" value="<?php echo $instructor->email; ?>">
              </div>
              <?php } ?>
            </div>
          </div>
